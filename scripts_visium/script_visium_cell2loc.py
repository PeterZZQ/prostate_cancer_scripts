...
result_dir = "../results_visium/results_cell2loc/"
...
adata_intact = sc.read_h5ad("../dataset/data_scrnaseq/seurat_integration/adata_intact_seurat.h5ad")
# raw counts
counts_ref = mmread("../dataset/data_scrnaseq/data/qc_data/X_intact.mtx")
# create reference dataset
adata_ref = AnnData(X = csr_matrix(counts_ref), obs = adata_intact.obs, var = adata_intact.var)
...
# In[]
# Cell2Loc preprocessing on referenc edataset
# preprocessing
