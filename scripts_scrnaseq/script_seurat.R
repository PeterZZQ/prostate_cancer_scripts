...
# # 2. [SANITY CHECK] transfer labels from the reference scRNA-seq dataset ----------------------
...
# # 3. Transfer labels to the castrated dataset ----------------------------------
...
# # 4. differential expression analysis across cell types, cell type annotations [USE SCANPY INSTEAD]------
...
# # 5. differential-expression genes across genotypes [USE SCANPY INSTEAD]-----------------------------
# # intact
